...
class ConfiguracoesViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //var pickerHorasSelectedRow = (self.pickerHoras.selectedRow(inComponent: 0) + 1)
        
        if (self.pickerHoras.selectedRow(inComponent: 0) + 1) == 1{
            labelPIckerHoras.text = "Me lembre de uma frase em \((self.pickerHoras.selectedRow(inComponent: 0) + 1)) hora"
            
        }
        else{
            labelPIckerHoras.text = "Me lembre de uma frase em \((self.pickerHoras.selectedRow(inComponent: 0) + 1)) horas"
    ...
    @IBAction func btnCriarNotificacao(_ sender: Any) {
        ...
        let trigger = UNTimeIntervalNotificationTrigger(timeInterval: TimeInterval((self.pickerHoras.selectedRow(inComponent: 0) + 1)*3600), repeats: repetirNotificacao)
