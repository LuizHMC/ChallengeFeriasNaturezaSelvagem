...
class InicioViewController: UIViewController {
    ...
    let setaesquerda = UIImage(named: "setaesquerda.png")
    //btnesquerdaoutlet.setImage(setaesquerda, for: .normal)
    
    let setaesquerdaapagada = UIImage(named: "setaesquerdaapagada.png")
    //btnesquerdaoutlet.setImage(setaesquerdaapagada, for: .normal)
    
    let setadireita = UIImage(named: "setadireita.png")
    //btndireitaoutlet.setImage(setadireita, for: .normal)
    
    let setadireitaapagada = UIImage(named: "setadireitaapagada.png")
    //btndireitaoutlet.setImage(setadireitaapagada, for: .normal)
